...
* this License is included in the repository, package, archive, installer, distribution, or directory;
* a source file identifies this License;
...
This License does not claim ownership over general ideas, abstract concepts, facts, mathematical principles, general methods, programming languages, or elements that are not legally protectable.
...
2. download one working copy for Personal Use;
3. create a reasonable number of private backup copies;
4. install the Software on Authorized Devices;
5. execute the Software locally on Authorized Devices;
6. compile source code locally where source code is provided;
7. study source code privately for personal education;
...
3. no Commercial Use occurs;
4. no Production Use occurs;
5. no Distribution occurs;
6. no public hosting occurs;
7. no service is provided to another person;
8. no AI System is trained, developed, evaluated, or improved;
9. no prohibited Automated Processing occurs;
10. no security or technological protection is circumvented;
11. all legal and proprietary notices remain intact;
12. Third-Party Materials are used in compliance with their own licenses;
13. no false claim of ownership or authorship is made;
14. no false affiliation or endorsement is implied;
15. no modified version is represented as official; and
16. no use prohibited elsewhere in this License occurs.
...
* distribute unmodified versions; or
...
* may not be represented as official; and
...
* does not misuse the Licensor’s branding; and
...
No right is granted to continued access, continued hosting, backward compatibility, service availability, account availability, API availability, or continuation of any feature.
...
* does not violate applicable product terms; and
